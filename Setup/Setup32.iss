...
;-- Main Setup Information
 ...
 Compression                     = ZIP/9
 OutputBaseFilename              = NetRouter32
 MinVersion                      = 0.0,5.0
...
[Files]
 ...
 Source: "..\Source\Console\Release\Win32\NetRouterMgt.exe";  DestDir: "{app}\Bin";  Components: Base\Management; Flags: IgnoreVersion;
 Source: "..\Source\Service\Release\Win32\NetRouterSvc.exe";  DestDir: "{app}\Bin";  Components: Service;         Flags: IgnoreVersion;
